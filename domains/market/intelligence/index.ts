...
import { EMPTY_INTELLIGENCE, useIntelligencePipelineQuery } from "@/domains/intelligence";
...
export function useMarketIntelligenceEngine(
  ...
  const data = intelligenceQuery.data ?? EMPTY_INTELLIGENCE;
  ...
  return {
    ...
    errorMessage:
      data.degradedState ??
      (intelligenceQuery.error instanceof Error ? intelligenceQuery.error.message : null),
  };
}
