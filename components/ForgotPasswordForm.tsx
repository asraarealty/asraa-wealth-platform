...
export default function ForgotPasswordForm() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#040915] px-4">
      <div className="w-full max-w-md">
        {/* Logo / branding */}
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center w-14 h-14 rounded-2xl bg-sky-500/10 border border-sky-400/25 mb-4">
            <svg
          ...
          <p className="text-slate-400 text-sm mt-1">Restore secure client workspace access</p>
        </div>

        {/* Card */}
        <div className="bg-[#0b1a3a]/85 border border-sky-400/20 rounded-2xl p-8 shadow-2xl">
          {success ? (
            <div className="space-y-4 text-center">
              <div className="flex items-center justify-center w-12 h-12 rounded-full bg-sky-500/10 border border-sky-400/25 mx-auto">
                <svg
              ...
              <p className="text-slate-300 text-sm">
                ...
                a secure restoration link managed by your advisory workspace.
              </p>
              <Link
                href="/login"
                className="inline-block mt-2 text-sm text-sky-300 hover:text-sky-200 transition"
              >
                Back to sign in
              </Link>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5" noValidate>
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-lg bg-[#020817]/60 border border-sky-400/20 text-white placeholder-slate-500 px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-sky-400/60 transition"
                />
              </div>
              ...
              >
                ...
                {loading ? "Sending…" : "Send secure restore link"}
              </button>
