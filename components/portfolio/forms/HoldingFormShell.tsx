...
function toHoldingDTO(asset: Asset | null | undefined): HoldingDTO | null {
  ...
  return {
    ...
    units: toNumber(read(record, "units")),
    purchasePrice: toNumber(read(record, "purchase_price", "avg_price")),
    purchaseNav: toNumber(read(record, "nav")),
    purchaseDate: typeof read(record, "purchase_date") === "string" ? String(read(record, "purchase_date")) : undefined,
    folioNumber: typeof read(record, "folio_number") === "string" ? String(read(record, "folio_number")) : undefined,
    ...
    valuation: {
      ...
      unrealizedPnl: toNumber(read(record, "unrealized_pnl")),
      gainLoss: toNumber(read(record, "gain_loss")),
      profitLoss: toNumber(read(record, "profit_loss")),
      returnPercent: toNumber(read(record, "return_percentage")),
      spotPrice: toNumber(read(record, "spot_price")),
      rentalYield: toNumber(read(record, "rental_yield")),
      appreciation: toNumber(read(record, "appreciation")),
      netReturn: toNumber(read(record, "net_return")),
    },
  };
}
