...
export default function OperationsReportsPage() {
  ...
  const totalLeasesToReview = data.realEstate.leaseExpiring + data.realEstate.leaseExpired;
  ...
  return (
    <div className="space-y-5">
      ...
      <section className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4">
        ...
        {metric("Lease expiry calendar", String(totalLeasesToReview))}
      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-4">
        ...
        <SimpleBarChart title="Lease expiry calendar" points={[
          ...
          { label: "Total", value: totalLeasesToReview },
        ]} />
