  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse at 50% 30%, rgba(255,77,109,0.07) 0%, transparent 60%)",
        }}
      />
      ...
      <div
        ...
        style={{
          ...
          boxShadow: "0 8px 40px rgba(0,0,0,0.5), 0 0 0 1px rgba(255,77,109,0.05)",
        }}
      >
        {/* Icon */}
        <div
        ...
        <p className="text-white/50 text-sm leading-relaxed mb-8">
          Unfortunately, your account application has not been approved at this
          time. If you believe this is an error or would like to appeal this
          decision, please reach out to our support team.
        </p>
